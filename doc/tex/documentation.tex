...
%Former:
%
%Strict distinction between user and developer documentation resulting in parts documented twice
%
%1. Intro
...
%3.2 Architecture
%3.3 Transformation
%3.4 Generation Backend
%
%New: 
%
%less strict distinction, document slowly moving from user doc to dev doc
%
%1. Intro
%2. Getting started (2.1 of old document)
%3. Architecture    (explanation of generated code, mixture of former 2.2 and 3.2)
%3.1 Client         (explanation of client side api, 2.2)
%3.2 Server         (explanation of server side "api", somewhere in 3.2/3.3)
%4. Generator       (explanation of the generator itself, former 3.3/3.4)
