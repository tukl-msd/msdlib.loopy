...
In contrast to the board-side driver, the host-side driver is the part of the driver which is located on the communicating computer. This part contains the actual API, embedded developers will work with. Sometimes, the term \textit{client} and \textit{client-side} might be used instead.
...
\node[class,fill=white, above right = -2.8em and -6.9em of vhdl3] (vhdl2) {};
