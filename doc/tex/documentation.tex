...
% Currently: Split after deployment location, i.e. host-side and board-side CFGs
% New: Split after port type, i.e. in-going and out-going.
%     in-going describes both, host-side and board-side
%     out-going also references polling ports
%     these look very similar to in-going ports (probably identical)
%     only difference at first glance: queues are of limited size --> cannot always store
