...
In this section, the board description language is introduced. This language is used to specify a board, for which a driver and project files should be generated. 
