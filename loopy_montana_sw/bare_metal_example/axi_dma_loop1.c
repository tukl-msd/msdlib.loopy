/* example of DMA driver from Xilinx
 * loopy project - SW branch
 * author: CV
 * date: October 2014
 *
 */
...
*
*
*DMA configuration functions - to be check and edited accordingly:CV
------------------------------------------------------------------------------------------------------------------*/
...
//-------------------------------------------------------------------------------------
	...
	/* Give the BD to DMA to kick off the transmission. */ //actual transaction:CV
...
{
	int Status;
	XAxiDma_Config *Config; // hw DMA config structure
...
//-------------------------------------------------------------------------------------------
	...
	Config = XAxiDma_LookupConfig(DMA_DEV_ID); //get DMA configuration from hardware, based on ID
	if (!Config) {
...
// check for scatter-gatherer mode
