...
public class ISE_14_1 extends ISE {
    ...
    public void generate(BDLFilePos board, Configuration config, ErrorCollection errors) {
        ...
        if( !(config.board() instanceof ISEBoard_14_1)) {
        ...
        sdk = ((ISEBoard_14_1)config.board()).getSDK_14_1(config, errors);
        super.generate(board, config, errors);
    }

    public Class<ISEBoard_14_1> getBoardInterface() {
        return ISEBoard.ISEBoard_14_1.class;
    }
}
